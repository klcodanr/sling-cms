		...
		<c:forEach var="asset" items="${assetlist.assets}">
			<div class="col-xs-6 col-sm-4 col-md-2">
				<div class="thumbnail asset-thumbnail ">
					...
					<a class="btn btn-xs btn-default fetch-html-modal" data-title="Edit Asset" title="Edit Asset" data-path="form" target="_blank" href="${sling:getRelativeResource(site.config,'assets').valueMap.assetEditor}.html${asset.path}/jcr:content">
