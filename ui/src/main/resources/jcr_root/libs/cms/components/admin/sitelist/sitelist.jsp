		...
		<c:forEach var="site" items="${sites.sites}" varStatus="status">
			<div class="col-sm-12 col-md-3">
				<div class="well">
					...
					<a class="btn btn-default btn-sm" title="Edit Site" href="/admin/site/home.html/${site.id}">
					...
					<a class="btn btn-sm btn-danger" title="Delete Site" href="/admin/site/delete.html/${site.id}?return=/admin/sites.html&path=/content/${site.id}">
