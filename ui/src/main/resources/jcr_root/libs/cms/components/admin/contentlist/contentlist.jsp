...
<ol class="breadcrumb">
	...
	<li>
		<a href="/admin/site/content.html/content/${site.id}">Content</a>
	</li>
	<c:forEach var="crumb" items="${contentlist.breadcrumb}" varStatus="status">
		<li>
			<c:choose>
				...
				<c:otherwise>
					<a href="/admin/site/content.html${crumb.path}">${crumb.title}</a>
				</c:otherwise>
			</c:choose>
		</li>
	</c:forEach>
...
<div class="row">
	<div class="col-lg-12">
		<a class="fetch-html-modal btn btn-primary" data-path="form" data-title="Add Page" href="/admin/site/createpage.html${slingRequest.requestPathInfo.suffix}"><i class="fa fa-plus"></i> Page</a>
		...
		<a class="fetch-html-modal btn btn-default" data-path="form" data-title="Add File" href="/admin/site/uploadfile.html${slingRequest.requestPathInfo.suffix}"><i class="fa fa-plus"></i> File</a>
	</div>
</div>
<br/>
<div class="row">
	                ...
	                <tr>
	                    <td> 
	                    	<c:choose>
	                    		...
	                    		<c:otherwise>
			                    	<a href="/admin/site/content.html${content.path}">
	                    				<sling:encode value="${content.title}" mode="HTML" />
			                    	</a>
	                    		</c:otherwise>
	                    	</c:choose>
